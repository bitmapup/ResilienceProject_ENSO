...
from module.Kullback import TransformData
import pandas as pd
...
def inicio() -> (list,list):
    ...
    data = pd.read_csv("/Users/gabriela/Downloads/resilience_project-kl/kullback/data/limon2017_KL.csv", sep="|", date_parser=dateparse, squeeze=True)
    print('#######')
    ...
    axes_x, result = TransformData.create_list(data, '2017-01-01', '2017-09-30', 'Price')
    print(len(result))

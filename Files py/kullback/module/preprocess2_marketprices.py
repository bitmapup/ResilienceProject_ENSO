...
from module.Kullback2 import TransformData
import pandas as pd
...
def inicio() -> (list,list):
    ...
    data1 = pd.read_csv("/Users/gabriela/Documents/datamining/resilience_project-kl/kullback/data/limon17_original.csv", sep=",",
                        date_parser=dateparse, squeeze=True)
    data2 = pd.read_csv("/Users/gabriela/Documents/datamining/resilience_project-kl/kullback/data/limon17_forecast.csv", sep=",", names=['Date', 'Price'],
                        date_parser=dateparse, squeeze=True )
    ...
    axes_x, result = TransformData.create_list(data1, data2, '2017-01-01', '2017-04-30', 'Price')
